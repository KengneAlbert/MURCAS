...
export function Navigation() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center w-full">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-[#003DA5] text-white px-6 py-2.5 rounded-xl
      ...
      <div className={`md:hidden fixed inset-x-0 top-[64px] bg-white/95 backdrop-blur-md 
      ...
      `}>
        <div className="px-4 py-6 space-y-4">
          ...
          <button className="w-full mt-4 bg-[#003DA5] text-white px-6 py-3 rounded-xl
            hover:bg-[#002D7A] active:bg-[#001F52]
