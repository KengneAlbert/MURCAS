...
import { Users, Building, Award, Target, Eye, Rocket, Heart, Shield, ChevronRight, ArrowRight, Smartphone, Check } from 'lucide-react';
...
export function AboutPage() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      designation: "Finance",
      image: "https://images.unsplash.com/photo-1551836022-deb4988cc6c0?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400&q=80",
    }
  ];
  ...
  return (
    <div className="py-20">
      ...
      <div className="relative bg-gradient-to-r from-[#003DA5] to-[#002D7A] py-32 mb-20 overflow-hidden">
        <div 
          className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1600880292203-757bb62b4baf?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80')] mix-blend-overlay opacity-20"
          style={{ transform: `translateY(${scrollY * 0.5}px)` }}
        ></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center text-white">
            <h1 className="text-5xl font-bold mb-6 animate-fade-in-up">À PROPOS DE</h1>
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto animate-fade-in-up delay-200">
              Votre partenaire de confiance depuis plus de 25 ans dans la protection sociale
              et l'accompagnement des travailleurs du secteur de l'énergie.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {tabs.map((tab) => (
            ...
            >
              <tab.icon className={`w-5 h-5 mr-2 transition-transform duration-300 ${
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-4xl font-bold mb-2 animate-count-up">{stat.number}</div>
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500">
                    <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-6 group-hover:translate-y-0 transition-transform duration-500">
                      <div className="flex flex-col items-center text-white">
                        <h3 className="text-2xl font-bold mb-2">{member.title}</h3>
          ...
          <div className="lg:flex items-center gap-16">
            ...
            <div className="lg:w-1/2 animate-fade-in-right">
              ...
              <p className="text-xl text-gray-600 mb-8">
                MURCAS FASAS continue d'innover et d'améliorer ses services pour répondre aux besoins
                évolutifs de ses membres. Notre engagement envers l'excellence et la satisfaction de
                nos membres reste notre priorité absolue.
              </p>
          ...
          <div className="lg:flex items-center gap-16">
            <div className="lg:w-1/2 mb-12 lg:mb-0">
              <div className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-md rounded-full mb-8">
                ...
                <span className="text-white/90 text-sm font-medium">Application Mobile</span>
              </div>
              ...
              <p className="text-xl text-gray-200 mb-12">
                Grace à notre application mobile, suivez-nous et réalisez toutes vos actions sans avoir besoin de vous déplacer.
              </p>
              ...
              <div className="space-y-6 mb-12">
                {[
                  ...
                  <div key={index} className="flex items-center space-x-4 text-white group">
